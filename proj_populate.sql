...
('3','Tumor Markers','2018-01-07','2019-04-01','done','1','e2'),
('4','Food and nutrition','2018-02-06',NULL,'ongoing','3','e5'),
('5','Exercise and Cardiac Output','2020-03-07','2021-07-01','done','2','e7'),
('6','Energy Drink and the Heart','2020-03-07',NULL,'ongoing','2','e7');

insert experiment values
('2','Impact of Omega Fatty Acid on Dementia Patients','2018-01-11',NULL,'Ongoing','4','e5','2018-01-05',1),
('3','Genetic Markers','2018-01-10','2019-04-01','Done','3','e2','2018-01-08',0),
('4','Serum Tumor Markers in Monitoring Cancer','2018-01-10',Null,'Ongoing','3','e2','2018-01-08',0),
...
insert trial values
('6','Energy drink drinkers',20,60,'A',10),
('2','Dementia',50,80,'A',10);


insert  publication values
('2','Study on Tumor Markers','Done','The Lancet Oncology', 
'2019-06-10','e2','2019-05-7','3'),
('3','Effects of Exercise on Cardiac Output', 'Planned','American Heart Association',	
NULL,'e7','2021-01-15', '5');
